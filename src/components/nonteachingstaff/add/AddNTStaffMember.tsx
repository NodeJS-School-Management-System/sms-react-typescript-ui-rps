  ...
  return (
    <Box>
      <Box
        ...
        my={3}
      >
        <Heading as={"h5"}>Non Teaching Staff Registration</Heading>
        <Text>SMS</Text>
      </Box>
      <Flex
        boxShadow="md"
        ...
        >
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              ...
              />
              <Input isRequired type="text" placeholder="First Name" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              ...
              />
              <Input isRequired type="text" placeholder="Last Name" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              <InputLeftElement
                ...
                children={<Person />}
              />
              <Input isRequired type="text" placeholder="Username" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              <InputLeftElement
                ...
                children={<DateRange />}
              />
              <Input isRequired type="text" placeholder="Date of Birth" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              <InputLeftElement
                ...
                children={<Home />}
              />
              <Input isRequired type="text" placeholder="Address" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              <InputLeftElement
                ...
                children={<Phone />}
              />
              <Input isRequired type="text" placeholder="Phone" />
            </InputGroup>
          </Center>
          ...
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              <InputLeftElement
                ...
                children={<WcOutlined />}
              />
              <Input isRequired type="text" placeholder="Gender" />
            </InputGroup>
          </Center>
        </WrapItem>
        ...
        >
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              ...
              />
              <Input isRequired type="text" placeholder="Class" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              ...
              />
              <Input isRequired type="text" placeholder="Stream" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              ...
              />
              <Input isRequired type="text" placeholder="Education Level" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              ...
              />
              <Input isRequired type="text" placeholder="Marital Status" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            <FormLabel alignSelf={"flex-start"}>Class</FormLabel>
          ...
          <Center flexDirection={"column"} w="90%" h="100%">
            ...
            <InputGroup>
              <InputLeftElement
                ...
                color="gray.400"
                width="2.5rem"
                children={<SubjectOutlined />}
              />
              <Input isRequired type="text" placeholder="Subject" />
            </InputGroup>
          </Center>
          <Center flexDirection={"column"} w="90%" h="100%">
            <FormLabel alignSelf={"flex-start"}>Profile Image</FormLabel>
            <Input border={"none"} isRequired type="file" />
          </Center>
          <Button variant={"solid"} colorScheme="facebook" px={20} py={4}>
            Add Member
          </Button>
        </WrapItem>
      </Flex>
