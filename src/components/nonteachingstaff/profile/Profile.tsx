            ...
            >
              <Box w={"100%"}>
                ...
                >
                  ...
                  >
                    <Text>Email </Text>
                    <Text color={"#2e5984"}> {nonteachingstaff.email}</Text>
                  </Flex>
                  <Flex
                    w={"100%"}
                    p={3}
                  ...
                  >
                    <Text>Contact </Text>
                    <Text color={"#2e5984"}> {nonteachingstaff.contact} </Text>
                  </Flex>
                  <Flex
                    w={"100%"}
                    p={3}
              ...
              <Box w={"100%"}>
                ...
                >
                  ...
                  <Flex
                    ...
                    flexDirection="row"
                  >
                    <Text fontSize={17}> {nonteachingstaff.department} </Text>
                    <Text fontSize={17}> {nonteachingstaff.rank} </Text>
