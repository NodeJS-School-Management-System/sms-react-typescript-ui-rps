import { Box, Text, Center, Flex, WrapItem, Button, Select } from "@chakra-ui/react";
  ...
  return (
    <Box>
      <Flex justifyContent={'space-between'} pr={10}>
        <Text fontSize={25} fontWeight='bold' ml={3}>View Routine</Text>
          ...
          <WrapItem flex={1} gap={6} flexDirection={'column'} h={'max-content'} w={{ base: '100%', md: '50%', lg: '50%' }}>
            <Center flexDirection={'column'} boxShadow={'lg'} borderRadius={2} pb={4} borderTop='3px solid #ccc' bg={'white'} height='auto' w='90%' h='100%'>
              <Box w={'100%'}>
                ...
                <Button variant={'solid'} w='50%' mx={3} colorScheme={'teal'}>Add</Button>
              </Box>
            </Center>
              ...
              <Box w={'100%'}>
                <Flex overflowX={'auto'} alignItems='flex-start' justifyContent='flex-start' flexDirection='column'>
                  ...
                  <Flex w={'100%'} p={3} borderTop='1px solid #ccc' alignItems='center' justifyContent='space-between' flexDirection='row'>
                    <Text fontSize={19} fontWeight='bold'>Routine</Text>
                    <Text fontSize={19} fontWeight='bold'>Published on</Text>
                    <Text fontSize={19} fontWeight='bold'>Option</Text>
                  </Flex>
                  <Flex w={'100%'} p={3} borderTop='1px solid #ccc' alignItems='center' justifyContent='space-between' flexDirection='row'>
                    <Text fontSize={19} fontWeight='bold'>sample_ro.png</Text>
                    <Text fontSize={19} fontWeight='bold'>2022-08-01 21:20:17</Text>
