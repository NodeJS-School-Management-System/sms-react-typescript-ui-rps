    ...
    <TableContainer>
      <Table variant="simple">
        ...
        <Tbody>
          <Tr>
            <Th>Address</Th>
            <Td>{teacher ? teacher.address : "N/A"}</Td>
          </Tr>
          <Tr>
            <Th>Gender</Th>
            <Td>{teacher ? teacher.gender : "N/A"}</Td>
          </Tr>
          <Tr>
            <Th>Department</Th>
    ...
    >
      ...
      <InputGroup>
        ...
        <Input
          isRequired
          type="text"
          placeholder={teacher ? teacher.username : "N/A"}
      ...
      <InputGroup>
        ...
        <Input
          isRequired
          type="text"
          placeholder={teacher ? teacher.email : ""}
      ...
      <InputGroup>
        ...
        <Input
          isRequired
          type="text"
          placeholder={teacher ? teacher.contact : "N/A"}
      ...
      <InputGroup>
        ...
        <Input
          isRequired
          type="text"
          placeholder={teacher ? teacher.address : "N/A"}
